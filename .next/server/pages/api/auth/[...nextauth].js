...
/* harmony import */ var _Services_ApiClient__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("iMaL");
...
const authOptions = {
  ...
  providers: [next_auth_providers_credentials__WEBPACK_IMPORTED_MODULE_1___default()({
    ...
    async authorize(credentials, req) {
      ...
      const res = await _Services_ApiClient__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].post(`${"http://teststudent.hiast.edu.sy/backend/public"}/api/login`, payload).then(function (response) {
