...
const ListStudents = ({ students, exam, type }: IStudentsProps) => {
  console.log(exam);
    ...
    if (type == 0)
      columns = [
        ...
        },
        {
          ...
          field: "candidate.personal_number",
        },
        {
          title: "اسم الطالب",
          field: "name",
        },
        {
          ...
          render: (rowData) => (
            <TextField
              value={
                initUpdateMarks.length > 0
                  ? initUpdateMarks.filter((e) => e.id == rowData.id)[0]?.mark
                  : ""
              }
              type="text"
              onChange={(event) =>
                handleUpdateMark(rowData.id, event.target.value)
              }
              disabled={updating}
            />
          ),
            ...
            <ActionTable
              ...
              Data={data.map((item: any) => {
                return {
                  ...item,
                  number: `${
                    !!item.candidate.registeration_number
                      ? item.candidate.registeration_number
                      : ""
                  }`,
